...
D1 ✅ D2 ✅ D3 ✗ (2 TB, actual 4 TB, dropped a factor of 2)
...
| Localhost RTT | n/a | 19.5 µs |
| RTT Mumbai | n/a | 54.2 ms |
| RTT São Paulo | n/a | 417.9 ms |

Surprising number

localhost round trip (19.5 µs) is **4.3x faster than an
...
localhost had the worst tail of anything measured, p99/p50 = 3.03x,
worse than São Paulo's 1.50x. Not the network. The scheduler.

Can't explain yet

Why my RAM read is 177 ns against a canonical 100 ns.
