"""
Day 2 lab, SOLUTION. All four TODOs filled in. Try estimate.py first.
The PREDICTIONS below are example guesses so the script runs. Put in your own.
